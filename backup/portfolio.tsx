...
import { Github, Linkedin, Mail, Phone, MapPin, ExternalLink, ChevronDown, Menu, X, Code2, Database, Blocks, Brain }
from 'lucide-react';
...
return rect.top <= 100 && rect.bottom>= 100;
    ...
    period: "October 2025",
    challenge: "Modern online shoppers expect seamless experiences across all devices, with instant cart updates and
    ...
    impact: "Delivered production-ready e-commerce platform with instant UI updates, secure authentication, and
    ...
    challenge: "Traditional bank appointment systems lack transparency and require multiple verification steps that
    frustrate users.",
    approach: [
    ...
    impact: "Reduced booking time by 40% while ensuring data integrity through blockchain verification with JWT
    authentication.",
    ...
    challenge: "Poor posture during desk work leads to health issues, but most people lack real-time feedback for
    correction.",
    approach: [
    ...
    impact: "Achieved 95% classification accuracy, providing reliable health monitoring with immediate feedback for desk
    workers.",
    ...
    <div className={`min-h-screen ${bgColor} ${textColor} transition-colors duration-300`}>
        ...
        <section id="hero" className="pt-32 pb-20 px-6">
            <div className="max-w-4xl mx-auto text-center">
                <div className="mb-6">
                    <span className={`inline-block px-4 py-2 rounded-full ${cardBg} border ${borderColor}
                        ${secondaryText} text-sm mb-4`}>
                ...
                <p className={`text-xl ${secondaryText} mb-8 max-w-2xl mx-auto`}>
                    ...
                    From e-commerce platforms to blockchain integrations, I create applications that solve real
                    problems.
                </p>

                <div className="flex flex-wrap gap-4 justify-center mb-12">
                    <button onClick={()=> scrollToSection('projects')}
                        className="px-8 py-3 bg-gradient-to-r from-cyan-500 to-emerald-500 rounded-lg font-semibold
                        hover:shadow-lg hover:shadow-cyan-500/50 transition-all"
                        >
                        View Projects
                    </button>
                    <button className={`px-8 py-3 ${cardBg} border ${borderColor} rounded-lg font-semibold
                ...
                <div className="flex gap-6 justify-center">
                    <a href="https://github.com/tarunteja" target="_blank" rel="noopener noreferrer"
                        className="hover:text-cyan-400 transition-colors">
                        <Github className="w-6 h-6" />
                    </a>
                    <a href="https://linkedin.com/in/tarunteja" target="_blank" rel="noopener noreferrer"
                        className="hover:text-cyan-400 transition-colors">
        ...
        <section id="projects" className="py-20 px-6">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="space-y-12">
                    ...
                    <div key={idx} className={`${cardBg} rounded-xl p-8 border ${borderColor} hover:border-cyan-400
                        transition-all`}>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex flex-wrap gap-2 pt-4">
                                ...
                                <span key={i} className={`px-3 py-1 ${cardBg} border ${borderColor} rounded-full
                                    text-sm`}>
                                    {tech}
                                </span>
                                ))}
        ...
        <section id="skills" className={`py-20 px-6 ${darkMode ? 'bg-gray-800' : 'bg-gray-100' }`}>
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div key={idx} className={`${cardBg} rounded-xl p-6 border ${borderColor} hover:border-cyan-400
                        transition-all`}>
                ...
                <div className="mt-12 text-center">
                    ...
                    <div className="flex flex-wrap gap-3 justify-center">
                        {['Python', 'JavaScript', 'TypeScript', 'Java', 'HTML5', 'CSS3', 'Git', 'VS Code', 'Vercel',
                        'Stripe'].map((tech) => (
                        <span key={tech} className={`px-4 py-2 ${cardBg} border ${borderColor} rounded-lg text-sm
                            hover:border-cyan-400 transition-all`}>
                            {tech}
                        </span>
                        ))}
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className={`${cardBg} rounded-xl p-8 border ${borderColor}`}>
                    <p className={`${secondaryText} text-lg leading-relaxed mb-6`}>
                        I'm a recent Computer Science graduate from CMR College of Engineering & Technology with a
                        passion
                        for building applications that bridge traditional web development with emerging technologies
                        like
                        blockchain and AI.
                    </p>

                    <p className={`${secondaryText} text-lg leading-relaxed mb-6`}>
                        My journey into software development started with curiosity about how applications work behind
                        the scenes.
                        Today, I combine full-stack expertise with a focus on user experience, creating solutions that
                        are both
                    ...
                    <div className={`mt-8 p-6 rounded-lg ${darkMode ? 'bg-cyan-900/20' : 'bg-cyan-50' } border
                        border-cyan-400/30`}>
        ...
        <section id="contact" className={`py-20 px-6 ${darkMode ? 'bg-gray-800' : 'bg-gray-100' }`}>
            <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-12">
                    <a href="mailto:tarunt462@gmail.com" className={`${cardBg} rounded-xl p-6 border ${borderColor}
                        hover:border-cyan-400 transition-all`}>
                    ...
                    <a href="tel:+916303288472" className={`${cardBg} rounded-xl p-6 border ${borderColor}
                        hover:border-cyan-400 transition-all`}>
                ...
                <div className="flex gap-6 justify-center">
                    <a href="https://github.com/tarunteja" target="_blank" rel="noopener noreferrer" className={`p-4
                        ${cardBg} rounded-full border ${borderColor} hover:border-cyan-400 transition-all`}>
                        <Github className="w-6 h-6" />
                    </a>
                    <a href="https://linkedin.com/in/tarunteja" target="_blank" rel="noopener noreferrer"
                        className={`p-4 ${cardBg} rounded-full border ${borderColor} hover:border-cyan-400
                        transition-all`}>
                        <Linkedin className="w-6 h-6" />
                    </a>
                </div>
